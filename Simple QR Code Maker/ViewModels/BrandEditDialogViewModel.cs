...
public sealed partial class BrandEditDialogViewModel : ObservableRecipient
{
    private BrandItem _original = new();
    ...
    public void Initialize(BrandItem original)
    {
        _original = original;
    ...
    public BrandItem? TryCreateEditedItem()
    {
        if (!IsNameValid)
            return null;
