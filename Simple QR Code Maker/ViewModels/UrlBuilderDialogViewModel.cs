...
public sealed partial class UrlBuilderDialogViewModel : ObservableRecipient
{
    ...
    public UrlBuilderDialogViewModel()
    {
    ...
    {
        _lines.Clear();
        _lines.AddRange(UrlBuilderHelper.ParseText(initialText).Select(line => line.Clone()));
        LoadLine(0);
    }
    ...
    {
        SaveCurrentLine();
        return UrlBuilderHelper.SerializeText(_lines);
    }
    ...
    [RelayCommand]
    private void RemoveQueryParameter(UrlBuilderQueryParameter? parameter)
    {
