...
public sealed partial class VCardBuilderDialog : ContentDialog
{
    ...
    private void OnPrimaryButtonClick(ContentDialog sender, ContentDialogButtonClickEventArgs args)
    {
        ...
        string serializedText = VCardBuilderHelper.Serialize(state);
    ...
    private void AddOptionalField_Click(object sender, RoutedEventArgs e)
    {
        if (sender is FrameworkElement element && TryGetOptionalField(element.Tag, out VCardOptionalFieldKind fieldKind))
            SetOptionalFieldVisible(fieldKind, true);
    }

    private void RemoveOptionalField_Click(object sender, RoutedEventArgs e)
    {
        if (sender is FrameworkElement element && TryGetOptionalField(element.Tag, out VCardOptionalFieldKind fieldKind))
    ...
    private static bool TryGetOptionalField(object? tag, out VCardOptionalFieldKind fieldKind)
    {
        fieldKind = default;
        return tag is string fieldName
