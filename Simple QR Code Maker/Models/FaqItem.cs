...
public class FaqItem
{
    ...
    public static readonly FaqItem[] AllFaqs = [
        ...
        new FaqItem { Title = "What if I print the QR Code smaller than the minimum size?", Content = "The scan distance and size have a linear relationship so halfing the QR Code halfs the scan distance; the same goes for increasing the size." },
